...
def calculate_celeba_latent_values(ds, model, limit=None):
    locs = []
    scales = []
    samples = []
    attrs = []
...
def update_model_tree(ds, model, epoch, output_dir, limit=None):
    #locs, scales, samples, labels = calculate_celeba_latent_values(ds, model, label_attr, limit=limit)
    locs, scales, samples, labels = calculate_celeba_latent_values(ds, model, limit=limit)
